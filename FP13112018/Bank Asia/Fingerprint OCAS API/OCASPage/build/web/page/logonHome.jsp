...
//           out.println("cust_type is "+cust_type);
            ...
            if ((request.getParameter("btnLogon") == null) ? false : true) {
                ...
                String URL="http://"+IPAdress+":"+PORT+"/OCASAPI/ENROLL_STATUS";
        ...
        %>
        <p>The name you input &nbsp;<Font size="4" color="#ff0000"> <%=cust_no%> </Font> &nbsp; is not register yet. Please     try again!</p>
            <%
                        }
                        else 
                        {
                            String reqname = request.getParameter("cust_no");
                            String redirectURL = "startverifyHome.jsp?cust_no=" + reqname+"&cust_type="+cust_type;
