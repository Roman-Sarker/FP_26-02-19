    ...
    <body>
        <%
            ...
            ENROLL_DATA enroll_data = famenroll2.prepareEnrollData(name, 1, app_user, data, name,
                    "ENROLL", ai_logid, " ", cust_type, "W", "123456");
            ...
            String URL="http://"+IPAdress+":"+PORT+"/FingerAPI/FingerEnrollment";
            ...
            if (output != null) 
            {
                ...
                if (jsonArray != null) { 
                    ...
                    if (errorFlag.equals("N")) {
                        out.println("Fingerprint is successfully enrolled by web service<br>");
                        ...
                        out.println("Fingerprint is not enrolled by web service");
