...
public class Parameter_Fixed_Verify {
    ...
    public String  getParameter(JspWriter out,String param,boolean invertedCommaFlag)
    {
        param = param.replaceAll("'", "");
        if(invertedCommaFlag)
            return insertInvertedComma(out,param);
        else 
            return param;
         
    } 
    
    String insertInvertedComma(JspWriter out,String param)
    {
