...
public class FingerVerification extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            serial_no = String.valueOf((long) jsonObject.get("serial"));
            ...
            depamount = (String) jsonObject.get("depamount");

            System.out.println(customerNumber);
            System.out.println(serial_no);
            System.out.println(fingerData);
            System.out.println(pOperationType);
            System.out.println(pAcId);
            System.out.println(app_user);
            System.out.println(pDeviceId);
            System.out.println(pEnrolFrom);
            System.out.println(pSessionId);
            System.out.println(pCustType);
            System.out.println(pLogId);
